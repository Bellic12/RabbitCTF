...
class Team(Base):
    ...
    captain_id = Column(Integer, ForeignKey("user.id"), unique=True, nullable=False, index=True)
    ...
    credential = relationship("TeamCredential", back_populates="team", uselist=False, cascade="all, delete-orphan")
